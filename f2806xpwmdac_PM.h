...
//                                  500,         \
//                                 }
#define F280X_PWMDAC_DEFAULTS  {  1000,     \
                              500,      \
                              0x4000,   \
                              0x4000,   \
                             }
...
/*  from (-PeriodMax,PeriodMax) to (0,PeriodMax) where HalfPerMax=PeriodMax/2   */  \
    ...
    if(ch == 7)                                                                     \
    {                                                                               \
        EPwm7Regs.CMPA.half.CMPA = _IQmpy(m.HalfPerMax,m.MfuncC1)+ m.HalfPerMax;    \
        EPwm7Regs.CMPB           = _IQmpy(m.HalfPerMax,m.MfuncC2)+ m.HalfPerMax;    \
    }                                                                               \
    else if(ch == 8)                                                                \
    {                                                                               \
        EPwm7Regs.CMPA.half.CMPA = _IQmpy(m.HalfPerMax,m.MfuncC1)+ m.HalfPerMax;    \
